...
public class Drive {
    ...
    public final double kpTurn = 1/20000.0;
    public final double kiTurn = 1/100000.0;
    public final double kdTurn = -1/10000.0;
    ...
    public void plannedTurnUpdate(){
        ...
        double error =  -Maths.smallestSignedAngle(ffwdAngle, getPredictedRobotYaw(5));//The difference between where we expect to be and where we are.
        ...
        Log.d("autodrive", "," + deltaTime + "," + getPredictedRobotYaw(5) + "," + ffwdAngle);
...
//    }
    public boolean plannedTurnChecker(){
        ...
        boolean isAboutEqual = Math.abs(Maths.smallestSignedAngle(getPredictedRobotYaw(5), targetAngle)) < 1 ;//&& Math.abs(leftDrive.getPower()) < 0.15 ;//FIXME: Bad stop requirement
